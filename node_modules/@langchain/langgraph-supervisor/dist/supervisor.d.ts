...
}>>({ agents, llm, tools, prompt, stateSchema, outputMode, addHandoffBackMessages, supervisorName, }: CreateSupervisorParams<AnnotationRootT>) => StateGraph<AnnotationRootT["spec"], AnnotationRootT["State"], AnnotationRootT["Update"], string, AnnotationRootT["spec"], AnnotationRootT["spec"], import("@langchain/langgraph").StateDefinition>;
